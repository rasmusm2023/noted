...
export const SectionItem = ({
  ...
  return (
    <div
      className={`p-4 ${
        section.backgroundColor || "bg-neu-gre-900"
    ...
    >
      ...
      <div className="flex items-center space-x-2">
        <button
          ...
          className="p-2 text-neu-gre-400 hover:text-red-500 transition-colors flex items-center justify-center focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-pri-blue-500 rounded-lg"
